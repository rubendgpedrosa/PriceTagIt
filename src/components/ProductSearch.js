  ...
  */
  ...
  return (
    <div className='max-w-sm pt-12 mt-10 mb-4 mx-auto'>
        ...
        </button>:<button disabled className="focus:outline-none bg-blue-500 h-full rounded text-gray-100 absolute right-0"><svg className="h-6 w-6 mt-1 mx-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
        </svg></button>
        }
        </div>
