...
const ProductCreate = ({submitProduct, categories}) => {
    ...
    return(
        <div className="mx-auto text-center pt-16 mt-12 p-2  max-w-md">
            ...
            <input id="search" className="bg-transparent border-b border-b-2 focus:border-blue-500 border-blue-200 w-screen text-gray-700 mx-3 mt-8 px-4 py-1 px-2 leading-tight focus:outline-none" value={newProduct.name} maxlength="38" onChange={event => setNewProduct({...newProduct, name: event.target.value})} type="text" placeholder="Product Name*" />
            </div>
